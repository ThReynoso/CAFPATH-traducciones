    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="#" data-translate="HomeNavHome">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="views/public/trackingForm.php" data-translate="HomeNavTracking">Tracking</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="views/public/FAQ.php" data-translate="HomeNavFAQ">FAQ</a>
                </li>
                <li class="nav-item">
            ...
            <div class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="views/auth/LoginViewUser.php" data-translate="HomeNavClientLogin">Client</a></li>
                    <li><a class="dropdown-item" href="views/auth/LoginViewEmployee.php" data-translate="HomeNavEmployeeLogin">Employee</a></li>
                </ul>
            </div>
            ...
            <div class="nav-item dropdown ms-2">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="#" onclick="changeLanguage('en'); return false;" data-translate="HomeNavLanguageEnglish">Inglés</a></li>
                    <li><a class="dropdown-item" href="#" onclick="changeLanguage('es'); return false;" data-translate="HomeNavLanguageSpanish">Español</a></li>
                </ul>
            </div>
